    ...
    <el-form ref="form" label-width="80px" size="large">
        <el-card shadow="never" class="!border-none flex mt-2">
            ...
            <el-form-item v-if="content.title_type == 1">
                <el-input v-model="contentData.title" maxlength="8" show-word-limit class="w-[300px]"
            ...
            <el-form-item label="分享标题">
                <el-input v-model="contentData.shareTitle" maxlength="10" show-word-limit class="w-[300px]"
                    placeholder="请输入分享标题"></el-input>
            </el-form-item>
            <el-form-item label="分享路径">
                <el-input v-model="contentData.sharePath" maxlength="20" show-word-limit class="w-[300px]"
                    placeholder="请输入分享标题"></el-input>
            </el-form-item>
            <el-form-item label="页面背景">
                <material-picker v-model="contentData.shareImage" :limit="1" size="100px" />
            </el-form-item>
            <el-form-item label="显示出席填写">
                <el-switch v-model="contentData.showForm"></el-switch>
            </el-form-item>
        </el-card>
    </el-form>
</template>
