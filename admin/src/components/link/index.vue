<template>
    <div class="link flex">
        <el-menu :default-active="activeMenu" class="flex-none w-[180px] min-h-[350px] link-menu" :default-openeds="[
            MenuTypeEnum.SHOP_PAGES,
            MenuTypeEnum.APPTOOL,
            MenuTypeEnum.WEDDING_PAGES,
            ...
            <el-sub-menu v-for="(item, index) in menus" :index="item.type" :key="index">
                ...
                <el-menu-item v-for="(sitem, sindex) in item.children" :index="sitem.type" :key="sindex"
        ...
        <div class="flex-1 ml-4 link-content">
            ...
            <wedding-pages v-model="activeLink" v-if="LinkTypeEnum.WEDDING_PAGES == activeMenu" />
        </div>
    </div>
</template>
...
import WeddingPages from './wedding-pages.vue'
...
const menus = ref([
    ...
    {
        name: '婚礼页面',
        type: MenuTypeEnum.WEDDING_PAGES,
        children: [
            {
                name: '基础页面',
                type: LinkTypeEnum.WEDDING_PAGES,
                link: {}
            }
        ]
    },
