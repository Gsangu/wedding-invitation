                                    ...
                                    <el-dropdown v-if="data.id > 0" :hide-on-click="false">
                                        ...
                                        <template #dropdown>
                                            <el-dropdown-menu>
                                                ...
                                                <popover-input @confirm="handleAddChildCate($event, data.id)"
        ...
        <div class="material__center flex flex-col">
            <div class="operate-btn flex">
                <div class="flex-1 flex">
                    <upload v-if="type == 'image'" class="mr-3" :data="{ cid: cateId }" :type="type"
                        :show-progress="true" @change="refresh">
                        <el-button type="primary">本地上传</el-button>
                    </upload>
                    <upload v-if="type == 'video'" class="mr-3" :data="{ cid: cateId }" :type="type"
                        :show-progress="true" @allSuccess="refresh">
                        <el-button type="primary">本地上传</el-button>
                    </upload>
                    <upload v-if="type == 'audio'" class="mr-3" :data="{ cid: cateId }" :type="type"
                        :show-progress="true" @allSuccess="refresh">
                        <el-button type="primary">本地上传</el-button>
                    </upload>
                    <upload v-if="type == 'file'" class="mr-3" :data="{ cid: cateId }" :type="type"
                        :show-progress="true" @allSuccess="refresh">
                        <el-button type="primary">本地上传</el-button>
                    </upload>
