<template>
    <div class="my-service bg-white mx-[20rpx] mt-[20rpx] rounded-lg p-[30rpx]" v-if="content.enabled">
        ...
        <div v-if="content.style == 1" class="grid grid-cols-4 gap-x-9 gap-y-7">
            <div v-for="(item, index) in showList" :key="index" class="flex flex-col items-center pt-[40rpx]"
