                ...
                <view class="mt-[30rpx]">
                    <form @submit="handleSubmit">
                        ...
                        <u-form-item required label="昵称" :labelWidth="120">
                            <input class="flex-1 h-[60rpx]" name="nickname" type="nickname" placeholder="请输入昵称" />
                        </u-form-item>
                        <view class="mt-[80rpx]">
                            <button class="bg-primary rounded-full text-white text-lg h-[80rpx] leading-[80rpx]"
...
console.log(111, showPrivacyPopup.value);
